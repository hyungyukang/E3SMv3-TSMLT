...
! HGKANG ---
  use solar_irrad_data,    only : sol_irrad, we, nbins, has_spectrum, sol_tsi, do_spctrl_scaling
! use solar_data,    only : sol_irrad, we, nbins, has_spectrum, sol_tsi, do_spctrl_scaling
