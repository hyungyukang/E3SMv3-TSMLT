...
!           print*, 'HGSO4 2.7', fgain_so4(n), uptkrate(n,i,k),uptkratebb(n)
...
!        print*, 'HGSO4 2.9', deltatxx,sum_uprt_so4
...
!        print*, 'HGSO4 2', sum_dqdt_so4,avg_uprt_so4, l_so4g
...
!           print*, 'HGSO4 3', sum_dqdt_so4,dqdt_so4(1)
...
!           print*, 'HGSO4 4', sum_dqdt_so4,dqdt_so4(1)
         end if
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGSUB 1',dqdt(i,k,80),q(i,k,80),qqcw(i,k,80),dqqcwdt(i,k,80)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGSUB 2',dqdt(i,k,80),q(i,k,80),qqcw(i,k,80),dqqcwdt(i,k,80)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGSUB 3',dqdt(i,k,80),q(i,k,80),qqcw(i,k,80),dqqcwdt(i,k,80)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGSUB 4',dqdt(i,k,80),q(i,k,80),qqcw(i,k,80),dqqcwdt(i,k,80)
!   end do
!   end do
...
!        print*, 'HGGASAER 1', lndpgn, dgncur_awet(i,k,n),lnsg
