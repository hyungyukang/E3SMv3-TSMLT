...
!-------------------------------------------------------
      ...
      do n = 1,pver
        itemp(:ncol,n) = 1._r8 / temp(:ncol,n)
      end do
      ...
      rate(:,:,503) = 9.6e-12_r8 * exp( -234._r8 * itemp(:,:) )
      ...
      call jpl( rate(1,1,259), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 5.9e-33_r8 * itemp(:,:)**1._r8
      kinf(:,:) = 1.1e-12_r8 * itemp(:,:)**(-1.3_r8)
      call jpl( rate(1,1,305), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 4.28e-33_r8
      kinf(:,:) = 9.3e-15_r8 * itemp(:,:)**(-4.42_r8)
      call jpl( rate(1,1,306), m, 0.8_r8, ko, kinf, n )

      ko(:,:) = 5.2e-30_r8 * itemp(:,:)**2.4_r8
      kinf(:,:) = 2.2e-10_r8 * itemp(:,:)**0.7_r8
      call jpl( rate(1,1,316), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 5.5e-30_r8
      kinf(:,:) = 8.3e-13_r8 * itemp(:,:)**(-2._r8)
      call jpl( rate(1,1,317), m, 0.6_r8, ko, kinf, n )
      ...
      call jpl( rate(1,1,344), m, 0.48_r8, ko, kinf, n )

      ko(:,:) = 9.7e-29_r8 * itemp(:,:)**5.6_r8
      kinf(:,:) = 9.3e-12_r8 * itemp(:,:)**1.5_r8
      call jpl( rate(1,1,345), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 8e-27_r8 * itemp(:,:)**3.5_r8
      kinf(:,:) = 3e-11_r8
      call jpl( rate(1,1,365), m, 0.5_r8, ko, kinf, n )

      ko(:,:) = 8e-27_r8 * itemp(:,:)**3.5_r8
      kinf(:,:) = 3e-11_r8
      call jpl( rate(1,1,391), m, 0.5_r8, ko, kinf, n )

      ko(:,:) = 9.7e-29_r8 * itemp(:,:)**5.6_r8
      kinf(:,:) = 9.3e-12_r8 * itemp(:,:)**1.5_r8
      call jpl( rate(1,1,452), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 9.7e-29_r8 * itemp(:,:)**5.6_r8
      kinf(:,:) = 9.3e-12_r8 * itemp(:,:)**1.5_r8
      call jpl( rate(1,1,455), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 9.7e-29_r8 * itemp(:,:)**5.6_r8
      kinf(:,:) = 9.3e-12_r8 * itemp(:,:)**1.5_r8
      call jpl( rate(1,1,458), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 9.7e-29_r8 * itemp(:,:)**5.6_r8
      kinf(:,:) = 9.3e-12_r8 * itemp(:,:)**1.5_r8
      call jpl( rate(1,1,465), m, 0.6_r8, ko, kinf, n )
...
!-------------------------------------------------------
      ...
      do k = 1,kbot
        itemp(:ncol,k) = 1._r8 / temp(:ncol,k)
      end do
      ...
      rate(:,:,166) = 3.5e-11_r8 * exp( -135._r8 * itemp(:,:) )
      rate(:,:,167) = 8e-12_r8 * exp( -2060._r8 * itemp(:,:) )
      rate(:,:,176) = 3e-11_r8 * exp( 200._r8 * itemp(:,:) )
      rate(:,:,177) = 1e-14_r8 * exp( -490._r8 * itemp(:,:) )
      rate(:,:,178) = 1.4e-10_r8 * exp( -470._r8 * itemp(:,:) )
      rate(:,:,181) = 4.8e-11_r8 * exp( 250._r8 * itemp(:,:) )
      rate(:,:,182) = 1.8e-11_r8 * exp( 180._r8 * itemp(:,:) )
      rate(:,:,183) = 1.7e-12_r8 * exp( -940._r8 * itemp(:,:) )
      rate(:,:,190) = 2.1e-11_r8 * exp( 100._r8 * itemp(:,:) )
      rate(:,:,194) = 1.5e-11_r8 * exp( -3600._r8 * itemp(:,:) )
      rate(:,:,195) = 5.1e-12_r8 * exp( 210._r8 * itemp(:,:) )
      rate(:,:,203) = 3.3e-12_r8 * exp( 270._r8 * itemp(:,:) )
      rate(:,:,204) = 3e-12_r8 * exp( -1500._r8 * itemp(:,:) )

      itemp(:,:) = 300._r8 * itemp(:,:)

      ko(:,:) = 4.4e-32_r8 * itemp(:,:)**1.3_r8
      kinf(:,:) = 7.5e-11_r8 * itemp(:,:)**(-0.2_r8)
      call jpl( wrk(1,1), m, 0.6_r8, ko, kinf, n )
      rate(:,:,175) = wrk(:,:)
