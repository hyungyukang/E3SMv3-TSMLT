...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 1',q(i,k,138),q(i,k,1),q(i,k,137),q(i,k,139)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 2', mmr(i,k,128),mmr(i,k,129),mmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 3', mmr(i,k,128),mmr(i,k,129),mmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 4', mmr(i,k,128),mmr(i,k,129),mmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 5',mmr(i,k,89), vmr(i,k,89)
!   end do
!   end do
...
!   call qsat(tfld(:ncol,:pver), pmid(:ncol,:pver), satv(:ncol,:pver), satq(:ncol,:pver))
! HGKANG ---
    do k = 1,pver
       do i = 1,ncol
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 6', vmr(i,k,128),vmr(i,k,129),vmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 7', vmr(i,k,128),vmr(i,k,129),vmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 6.1', vmr(i,k,128),vmr(i,k,129),vmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 6.2', vmr(i,k,128),vmr(i,k,129),vmr(i,k,130)
!   end do
!   end do
    !-----------------------------------------------------------------------
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 6.3', vmr(i,k,128),vmr(i,k,129),vmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 6.4', vmr(i,k,128),vmr(i,k,129),vmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 6.5', vmr(i,k,128),vmr(i,k,129),vmr(i,k,130)
!   end do
!   end do
    endif
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 6.61', vmr(i,k,128),vmr(i,k,129),vmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 6.6', vmr(i,k,128),vmr(i,k,129),vmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 6.7', vmr(i,k,128),vmr(i,k,129),vmr(i,k,130)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 8', mmr(i,k,137),mmr(i,k,138),mmr(i,k,139)
!   end do
!   end do
...
!   do k = 1,pver
!   do i = 1,ncol
!      print*, 'HGCHEMDR 9', mmr(i,k,137),mmr(i,k,138),mmr(i,k,139)
!   end do
!   end do
