...
subroutine modal_aero_wateruptake_dr(state, pbuf, list_idx_in, dgnumdry_m, dgnumwet_m, &
                                     ...
                                     so4dryvol_m, naer_m, clear_rh_in)
!-----------------------------------------------------------------------
!
...
!-----------------------------------------------------------------------
   ...
   real(r8), optional ,target                :: dgnumdry_m(:,:,:)
   real(r8), optional ,target                :: dgnumwet_m(:,:,:)
   real(r8), optional ,target                :: qaerwat_m(:,:,:)
   real(r8), optional ,target                :: wetdens_m(:,:,:)
   real(r8), optional ,target                :: hygro_m(:,:,:)
   real(r8), optional ,target                :: dryvol_m(:,:,:)
   real(r8), optional ,target                :: dryrad_m(:,:,:)
   real(r8), optional ,target                :: drymass_m(:,:,:)
   real(r8), optional ,target                :: so4dryvol_m(:,:,:)
   real(r8), optional ,target                :: naer_m(:,:,:)
...
!  do i = 1,ncol
!  do k = 1,pver
!     print*, 'QAWERWAT in take 1', dgncur_awet(i,k,m),dgncur_a(i,k,m)
!  end do
!  end do
!  end do
...
!  do m = 1,ncol
!  do k = 1,pver
!     print*, "QAERWAT in waterup",list_idx,m,k,qaerwat(m,k,1),qaerwat(m,k,2),qaerwat(m,k,3),qaerwat(m,k,4),dgncur_awet(m,k,1),dgncur_awet(m,k,2)
!  end do
!  end do
...
!  do i = 1,ncol
!  do k = 1,pver
!     print*, 'HGDRYRAD in take 1', dryrad(i,k,m),wetrad(i,k,m),i,k,m,list_idx
!  end do
!  end do
!  end do
...
!  do i = 1,ncol
!  do k = 1,pver
!     print*, 'HGDRYRAD in take 2', dryrad(i,k,m),wetrad(i,k,m),i,k,m
!  end do
!  end do
!  end do
   qaerwat = 0.0_r8
